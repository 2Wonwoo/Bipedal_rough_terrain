...
**진행 중 — 아직 없다.** 200 env, 3000 iteration 학습이 진행 중이며 완료
후 v34c10과 같은 형식(정지 속력·추종·짧은 접촉·리워드·에피소드)으로 이
자리에 채운다. 판정 기준은 v34c10 대비: (1) 험지에서 안 넘어지는지,
(2) 그 대가로 평지 성능(정지 0.0058 · 추종 0.0166)이 얼마나 희생되는지.
