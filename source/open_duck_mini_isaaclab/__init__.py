...
try:
    ...
    # v61 + 옆 명령 구간에서 발 좌우 억제를 낮춤
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V62-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V62",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # v62 + 마찰 무작위화를 아래로 (0.5 -> 0.3)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V63-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V63",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # v59 + 보간격 0.18 -> 0.22 (2순위를 기하로)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V64-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V64",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )
    ...
    # v59 + 접지 중 발 수평속도 벌점 (미끄러짐)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V66-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V66",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # v59 + 고관절이 바깥으로 벌어지는 것을 막음 (쩍벌)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V67-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V67",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # v61 + 낙상 보수화 + 토크 강화 + 탐색 시그마 1.3
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V68-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V68",
    ...
    # v68 + 토크 벌점 절반 (후진 회복)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V69-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V69",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )

    # v65 + 몸통 CoM 뒤로 ({"V70":10,"V71":15,"V72":20}["V70"]) mm
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V70-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V70",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # v65 + 몸통 CoM 뒤로 ({"V70":10,"V71":15,"V72":20}["V71"]) mm
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V71-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V71",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # v65 + 몸통 CoM 뒤로 ({"V70":10,"V71":15,"V72":20}["V72"]) mm
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V72-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V72",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )
    ...
    # 우리 포크 전용 (upstream에 없음). v75 + 평지/자갈/자갈돌 혼합 지형.
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V75Rough-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V75Rough",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )

    # 우리 포크 전용 (upstream에 없음). V75Rough + 보행 위상 동기 목 움직임(최종판).
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V75RoughHead-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V75RoughHead",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )

    # v75 + 도메인 랜덤화 확대 (마찰 0.4~1.3 · 강성 0.8~1.2 · 외란 +-1.5 m/s / 3~8 s).
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V76-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V76",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )
    ...
    # v75 + path frame 제거, yaw 를 heading 오차에서 생성 (관측 107 -> 104).
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V78-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V78",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )

    # 대조군: path frame 만 제거 (관측 104)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V79-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V79",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )
    ...
    # v79 + heading 0.2
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V80-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V80",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )

    # v75 + heading 0.2 (path frame 유지, 관측 107)
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V81-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V81",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )

    # v75 + path frame 의 횡방향만 제거 (관측 106). 방위 적분 항은 유지.
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-V82-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_V82",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Explore13",
        },
    )
