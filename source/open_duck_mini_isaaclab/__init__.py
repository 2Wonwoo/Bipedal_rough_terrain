...
try:
    ...
    # v49 + 평지/자갈/자갈돌 혼합 지형 (병렬 환경 절반씩) + 정지 hip_inward 수정.
    gym.register(
    ...
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-Rough3-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_Rough3",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )

    # Rough3 + 정지 시 목이 확실히 수평으로(리워드 게이트 수정) + 진폭 축소.
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-Rough4-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_Rough4",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )
    ...
    gym.register(
        id="Isaac-OpenDuckMini-Joystick-Rough5-v0",
        entry_point=f"{__name__}.tasks.velocity.joystick_env:JoystickEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{__name__}.tasks.velocity.joystick_env_cfg:JoystickEnvCfg_Rough5",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JoystickPPORunnerCfg_Gamma097",
        },
    )
