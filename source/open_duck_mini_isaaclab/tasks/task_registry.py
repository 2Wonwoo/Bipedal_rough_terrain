...
ENV_CFG_CLASS = {
    ...
    "Isaac-OpenDuckMini-Joystick-V65-v0": "JoystickEnvCfg_V65",
    ...
    "Isaac-OpenDuckMini-Joystick-V70-v0": "JoystickEnvCfg_V70",
    ...
    # 우리 포크 전용 (upstream에 없음) — 지형 학습 + 목 움직임, v75 기반.
    "Isaac-OpenDuckMini-Joystick-V75Rough-v0": "JoystickEnvCfg_V75Rough",
    "Isaac-OpenDuckMini-Joystick-V75RoughHead-v0": "JoystickEnvCfg_V75RoughHead",
...
_BIG_NET_TASKS = {
    ...
    "Isaac-OpenDuckMini-Joystick-V65-v0",
    ...
    "Isaac-OpenDuckMini-Joystick-V70-v0",
    ...
    "Isaac-OpenDuckMini-Joystick-V75Rough-v0",
    "Isaac-OpenDuckMini-Joystick-V75RoughHead-v0",
