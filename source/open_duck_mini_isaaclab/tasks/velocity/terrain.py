"""Gravel/rough-terrain generator for the terrain-mix experiment (v35).
...
every iteration), not a progressive difficulty ramp. See
docs/training_log.md's v35 entry for why.
"""
